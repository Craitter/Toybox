...
#include "ToyboxAbilityTagRelationshipMapping.generated.h"


/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FToyboxAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class TOYBOX_API UToyboxAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FToyboxAbilityTagRelationship> AbilityTagRelationships;
};
